...
.catch(error => { 
 ...
 person.create([
    ...
    { name: "Nader", age: 32, favoriteFoods: ["Suchi", "Salad Cesar", "Kabeb"] },
    { name: "Mohamed", age: 20, favoriteFoods: ["Sandwich", "Grillet"] },
  ...
  Person.findOneAndUpdate({name : "souhaib"},{$set : {age :32}})
  .then((data) => {
